...
public class CalendarLayout extends LinearLayout {
    ...
    public CalendarLayout(final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ImageView SetTime = addView.findViewById(R.id.setventtime);
                    ...
                    public void onClick(View v) {
                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(addView.getContext(), R.style.Theme_AppCompat_Dialog, new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                SimpleDateFormat hformate = new SimpleDateFormat("K:m a");
    ...
    private void IntializeLayout(){
        ...
        moth = view.findViewById(R.id.current_date);
        gridView = view.findViewById(R.id.gridView);
    }
    private void SetUpCalendar(){
        String curwnDate = dateFormat.format(calendar.getTime());
        moth.setText(curwnDate);
        dates.clear();
